...
<?php
	...
	$page_title = 'اسباب رجوع الخدمات والمنتجات والطلبات'; //You can edit this to change your page title.
	...
	<!--content here-->
    <p>
	    <a href="manage_reasons.php" class="btn btn-primary btn-default">أضف جديد الآن</a>
    </p>
