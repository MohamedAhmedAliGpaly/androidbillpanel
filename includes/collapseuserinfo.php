...
</head><!--Top Onclick area Starts here-->
					...
					<div class="user-info">
						...
						<div class="user-details">
							...
							<div class="user-links">
								<a href="edit_profile.php?user_id=<?php echo $_SESSION['user_id']; ?>" class="btn btn-primary">
								تعديل حسابي وشكرآ</a>
							</div>
						</div>
					</div>
				...
				<div class="col-md-4 link-blocks-env">
					<div class="links-block left-sep">
						...
						<ul class="list-unstyled">
							<li>
								<strong>الجنس: </strong> <?php echo $new_user->get_user_info($_SESSION['user_id'], 'gender'); ?>
							</li>
                            <li>
								<strong>تاريخ الميلاد: </strong> <?php echo $new_user->get_user_info($_SESSION['user_id'], 'date_of_birth'); ?>
							</li>
                            <li>
								<strong>اي بي خاص بي: </strong> <?php $ipAddress = get_client_ip(); echo $ipAddress; ?>
							</li>
						</ul>
					</div>
