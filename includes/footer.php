    ...
    <div class="footer-inner">
        <!-- Add your copyright text here -->
       	<div class="footer-text">
            <p align="center" dir="rtl"><font color="#FFFFFF">جميع الحقوق محفوظة 
			لدي لايف هوست وم.محمد جبيلي وفريق العمل - <span lang="en-us">
			Life-host.info , lifehost.info </span>( جميع الحقوق محفوظه لدي 
			اصحابها ) </font> 
        </div>
