...
class Warehouse {
	...
	function list_warehouses() {
		...
		while($row = $result->fetch_array()) { 
			...
			$content .= $contact;
			$content .= '</td><td>';
			$content .= '<a href="warehouse_transfer_logs.php?warehouse_id='.$warehouse_id.'">سجلات النقل</a>';
			$content .= '</td>';
			...
			$content .= '<input type="submit" class="btn btn-default btn-sm" value="تعديل">';
			$content .= '</form>';
			$content .= '</td><td>';
			...
			$content .= '<input type="submit" class="btn btn-default btn-sm" value="حذف">';
			$content .= '</form>';
			$content .= '</td>';
			}
			$content .= '</tr>';
