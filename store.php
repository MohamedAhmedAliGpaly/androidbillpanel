...
<?php
	...
	if(isset($_GET['message']) && $_GET['message'] == 'warehouse') { 
		...
		$message = "لاتستطيع الولوج الي هذا المتجر او الخدمه";
	}
	...
	.pull-left {
        ...
        <div class="pull-left">
            <div class="TopImg">
                ...
                <div class="bottomName">
                        <a href="purchase.php">المشتريات</a>
                </div><!--bottomName-->
        </div><!--pull-left-->
		<?php endif; ?>
        ...
        <div class="pull-left">
            <div class="TopImg">
                ...
                <div class="bottomName">
                        <a href="clients.php">الحسابات والآشخاص</a>
                </div><!--bottomName-->
        </div><!--pull-left-->
		<?php endif; ?>
        ...
        <div class="pull-left">
            <div class="TopImg">
                ...
                <div class="bottomName">
                        <a href="products.php">المنتجات والخدمات</a>
                </div><!--bottomName-->
        </div><!--pull-left-->
        <?php endif; ?>
        ...
        <div class="pull-left">
            <div class="TopImg">
                ...
                <div class="bottomName">
                        <a href="warehouse.php">المخازن</a>
                </div><!--bottomName-->
        </div><!--pull-left-->
		<?php endif; ?>
        ...
        <div class="pull-left">
            <div class="TopImg">
                ...
                <div class="bottomName">
                        <a href="sale_returns.php">المسترجعات</a>
                </div><!--bottomName-->
        </div><!--pull-left-->
		<?php endif; ?>
        ...
        <div class="pull-left">
            <div class="TopImg">
                ...
                <div class="bottomName">
                        <a href="set_product_rates.php">مستوي الاسعارّ</a>
                </div><!--bottomName-->
        </div><!--pull-left-->
		<?php endif; ?>
        <?php if(partial_access('admin') || $store_access->have_module_access('sales')): ?>
        <div class="pull-left">
            <div class="TopImg">
                ...
                <div class="bottomName">
                        <a href="point_of_sale.php">نقاط البيع</a>
                </div><!--bottomName-->
        </div><!--pull-left-->
		<?php endif; ?>
