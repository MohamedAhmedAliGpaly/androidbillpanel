...
<table width="95%" align="right" cellspacing="0" style="margin-top:5px; text-align:right;margin-bottom:5px;" cellpadding="5" border="0px">
        		<tr>
                	<td><strong>Total:</strong> <?php echo currency_format($invoice_detail['grand_total']); ?> <?php echo $new_store->get_store_info($_SESSION['store_id'], 'currency'); ?></td></tr>
                    <tr>
                    <td><strong>Received:</strong> <?php echo currency_format($invoice_detail['received_amount']); ?> <?php echo $new_store->get_store_info($_SESSION['store_id'], 'currency'); ?></td></tr>
                    <tr><td><strong>Balance:</strong> <?php echo currency_format($invoice_detail['grand_total']-$invoice_detail['received_amount']); ?> <?php echo $new_store->get_store_info($_SESSION['store_id'], 'currency'); ?></td>
                </tr>
                </table>
